...
import { Container, Header, Content, Form, Item, Input, List, Title, Footer, Left, Right, Button, Icon, Card, Body, CardItem, FooterTab, Tab, Tabs, ListItem } from 'native-base';
